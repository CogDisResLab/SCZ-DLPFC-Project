...
params:
  chip_type: STK
  signal_file: "kinome_data/DISC1/_KRSAsOutput_Median_SigmBg_250421102119.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/DISC1/_KRSAsOutput_Signal_Saturation_250421102120.txt" # Change the file name to the one you have
...
qc_data <- krsa_qc_steps(raw_data) |>
  mutate(
    SampleName = case_when(
      Barcode == "710317319" & Array == "A1" ~ "C3N",
      Barcode == "710317320" & Array == "A1" ~ "C3N",
      .default = SampleName
    ),
    Group = SampleName,
