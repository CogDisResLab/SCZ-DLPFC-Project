---
title: "Rat Prefrontal Cortex Kinome Profiling - Haloperidol Treatment"
...
params:
  ...
  signal_file: "kinome_data/haloperidol-rats/rats-haloperidol_SigmBg.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/haloperidol-rats/rats-haloperidol_Saturation.txt" # Change the file name to the one you have
...
raw_data <- krsa_read(
  ...
  filter(Barcode == "701032204", SampleName == "Brain")
```
...
qc_data <- krsa_qc_steps(raw_data) |>
  mutate(
    Group = if_else(`Comment 1` == "CT", "Control", "Haloperidol"),
...
- Haloperidol-treated Rats vs Control Rats
