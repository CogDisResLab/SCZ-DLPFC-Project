...
params:
  ...
  signal_file: "kinome_data/cell-level/run2_KRSA_files_Median_SigmBg_210520201325.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/cell-level/run2_KRSA_files_Signal_Saturation_210520201326.txt" # Change the file name to the one you have
