...
comparisons <- list(
  COMP1 = c(subject_pairs[["SCZ"]][[1L]], subject_pairs[["CTL"]][[1L]]),
  COMP2 = c(subject_pairs[["SCZ"]][[2L]], subject_pairs[["CTL"]][[2L]]),
  COMP3 = c(subject_pairs[["SCZ"]][[3L]], subject_pairs[["CTL"]][[3L]]),
  COMP4 = c(subject_pairs[["SCZ"]][[4L]], subject_pairs[["CTL"]][[4L]]),
  COMP5 = c(subject_pairs[["SCZ"]][[5L]], subject_pairs[["CTL"]][[5L]]),
  COMP6 = c(subject_pairs[["SCZ"]][[6L]], subject_pairs[["CTL"]][[6L]])
)
```
