# Create a CAMK Volcano Plot

library(tidyverse)

dataset <- read_csv("results/CAMK_subset_SCZ_lookup.csv") |>
...
ggsave("CAMK-Volcano-Plot.png", plot = p, width = 16, height = 8, units = "in", path = "figures", bg = "white")
