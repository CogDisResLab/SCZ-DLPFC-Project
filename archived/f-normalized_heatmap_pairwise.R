...
png(file.path("figures", "normalized_unscaled-all_pairs_heatmap.png"), width = 11, height = 8.5, units = "in", res = 300)
krsa_heatmap(r_scaled$normalized, final_passed_peps, scale = "none")
dev.off()

png(file.path("figures", "normalized_scaled-all_pairs_heatmap.png"), width = 11, height = 8.5, units = "in", res = 300)
krsa_heatmap(r_scaled$normalized, final_passed_peps, scale = "row")
dev.off()
