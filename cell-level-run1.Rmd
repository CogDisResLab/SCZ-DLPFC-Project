...
params:
  ...
  signal_file: "kinome_data/cell-level/run1_KRSAsfiles_Median_SigmBg_210518210643.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/cell-level/run1_KRSAsfiles_Signal_Saturation_210518210643.txt" # Change the file name to the one you have
