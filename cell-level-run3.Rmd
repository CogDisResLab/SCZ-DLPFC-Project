---
title: "Human DLPFC Kinome Profiling - Cell Level"
subtitle: "Drs. Ali Imami and Robert McCullumsmith"
...
params:
  ...
  signal_file: "kinome_data/cell-level/run3_KRSA_files_Median_SigmBg_210519103637.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/cell-level/run3_KRSA_files_Signal_Saturation_210519103637.txt" # Change the file name to the one you have
...
# Load the subject pairings
subject_pairs <- read_csv(file.path("kinome_data", "subject_pairs.csv")) |>
  filter(Run == 3L)
```
...
- `r subject_pairs[["SCZ"]][[1L]]` vs `r subject_pairs[["CTL"]][[1L]]`
- `r subject_pairs[["SCZ"]][[2L]]` vs `r subject_pairs[["CTL"]][[2L]]`
- `r subject_pairs[["SCZ"]][[3L]]` vs `r subject_pairs[["CTL"]][[3L]]`
- `r subject_pairs[["SCZ"]][[4L]]` vs `r subject_pairs[["CTL"]][[4L]]`
- `r subject_pairs[["SCZ"]][[5L]]` vs `r subject_pairs[["CTL"]][[5L]]`
- `r subject_pairs[["SCZ"]][[6L]]` vs `r subject_pairs[["CTL"]][[6L]]`
...
comparisons <- list(
  COMP1 = c(subject_pairs[["SCZ"]][[1L]], subject_pairs[["CTL"]][[1L]], subject_pairs[["Designation"]][[1L]]),
  COMP2 = c(subject_pairs[["SCZ"]][[2L]], subject_pairs[["CTL"]][[2L]], subject_pairs[["Designation"]][[2L]]),
  COMP3 = c(subject_pairs[["SCZ"]][[3L]], subject_pairs[["CTL"]][[3L]], subject_pairs[["Designation"]][[3L]]),
  COMP4 = c(subject_pairs[["SCZ"]][[4L]], subject_pairs[["CTL"]][[4L]], subject_pairs[["Designation"]][[4L]]),
  COMP5 = c(subject_pairs[["SCZ"]][[5L]], subject_pairs[["CTL"]][[5L]], subject_pairs[["Designation"]][[5L]]),
  COMP6 = c(subject_pairs[["SCZ"]][[6L]], subject_pairs[["CTL"]][[6L]], subject_pairs[["Designation"]][[6L]])
)
```
...
case <- comparisons[["COMP5"]][[1L]]
ctrl <- comparisons[["COMP5"]][[2L]]
tag <- comparisons[["COMP5"]][[3L]]
random <- "E"
threshold <- params[["threshold"]]
...
case <- comparisons[["COMP6"]][[1L]]
ctrl <- comparisons[["COMP6"]][[2L]]
tag <- comparisons[["COMP6"]][[3L]]
random <- "F"
threshold <- params[["threshold"]]
